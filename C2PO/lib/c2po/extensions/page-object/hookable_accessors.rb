...
# rubocop:disable Metrics/ModuleLength, Metrics/AbcSize, Metrics/CyclomaticComplexity
module PageObject
  module Platforms
    module Watir
      #
  ...
  module Accessors
    ...
    def _add_common_hook_methods
      ...
      define_method(:cached_hooks) do |hook_defs, ele_name|
        ...
        hook_cache[ele_name] ||= CptHook::Hookable.new(nil, hook_defs, self)
      end
    end
...
# rubocop:enable Metrics/ModuleLength, Metrics/AbcSize, Metrics/CyclomaticComplexity
